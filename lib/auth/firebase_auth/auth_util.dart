...
DocumentReference? get currentUserReference =>
    loggedIn ? FuncionarioRecord.collection.doc(currentUser!.uid) : null;

FuncionarioRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : FuncionarioRecord.getDocument(FuncionarioRecord.collection.doc(uid))
              .handleError((_) {}),
    )
